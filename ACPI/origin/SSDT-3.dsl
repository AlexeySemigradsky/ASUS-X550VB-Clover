 ...
 *
 * Disassembly of SSDT-3.aml, Wed Mar 14 19:38:44 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000B18 (2840)
 *     Revision         0x01
 *     Checksum         0x06
 *     OEM ID           "PmRef"
 *     OEM Table ID     "CpuPm"
...
DefinitionBlock ("", "SSDT", 1, "PmRef", "CpuPm", 0x00003000)
{
    ...
    External (_SB_.PTID.WPMD, MethodObj)    // 1 Arguments
    ...
    Scope (\_PR)
    {
        OperationRegion (PPMT, SystemMemory, 0xCA874E18, 0x0029)
