 ...
 *
 * Disassembly of DSDT.aml, Wed Mar 14 19:38:44 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00013C60 (80992)
 *     Revision         0x02
 *     Checksum         0xD6
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000013)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCA85CE18, 0x01D1)
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    ...
                    If (LEqual (IIA0, 0x00120041))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x2E, Local2)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        Method (_QCE, 0, NotSerialized)  // _Qxx: EC Query
        {
            Store (0x50, DBG8)
            Store (0x1E, Local2)
            While (LGreaterEqual (Local2, Zero))
            {
                Stall (0x5A)
                Decrement (Local2)
                If (LEqual (Local2, Zero))
    ...
    Scope (_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store (0x30, DBG8)
            Store ("Begin == Entering GC6 ============", Debug)
            Store (One, LNKD)
            While (LNotEqual (LNKS, Zero))
            {
                Stall (0x5A)
            ...
            ^^^LPCB.EC0.WRAM (0x03A4, Zero)
            ^^^LPCB.EC0.WRAM (0x03A5, Zero)
            Store ("End of == Entering GC6 ============", Debug)
            Return (One)
        }
        ...
        Method (OGC6, 4, Serialized)
        {
            ...
            While (One)
            {
                ...
                ElseIf (LEqual (_T_0, 0x06))
                {
                    Store ("JT fun6 JT_FUNC_MDTL", Debug)
